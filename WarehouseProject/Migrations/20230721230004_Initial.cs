        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipUnits = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PicklistProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PicklistId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PicklistProducts", x => x.PicklistProductId);
                    table.ForeignKey(
                        name: "FK_PicklistProducts_Picklists_PicklistId",
                        column: x => x.PicklistId,
                        principalTable: "Picklists",
                        principalColumn: "PicklistId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PicklistProducts_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PicklistProducts_PicklistId",
                table: "PicklistProducts",
                column: "PicklistId");

            migrationBuilder.CreateIndex(
                name: "IX_PicklistProducts_ProductId",
                table: "PicklistProducts",
                column: "ProductId");
