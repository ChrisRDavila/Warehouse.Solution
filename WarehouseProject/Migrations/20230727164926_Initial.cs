        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipBy = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Picklists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PicklistProductTypes_ProductTypes_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ProductTypeId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "WarehouseProductTypes",
                columns: table => new
                {
                    WarehouseProductTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseProductTypes", x => x.WarehouseProductTypeId);
                    table.ForeignKey(
                        name: "FK_WarehouseProductTypes_ProductTypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductTypes",
                        principalColumn: "ProductTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WarehouseProductTypes_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PicklistProductTypes_PicklistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseProductTypes_ProductTypeId",
                table: "WarehouseProductTypes",
                column: "ProductTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseProductTypes_WarehouseId",
                table: "WarehouseProductTypes",
                column: "WarehouseId");
